...
## 2 · The 22 substrate primitives

Locked from Council of Twelve audit (2026-07-03) plus Master of Thought safety + physical-security + governance + evolution + provenance additions (2026-07-04). Original 10 + 5 (Council) + 2 (MoT hardware-safety) + 1 (MoT onboard-security) + 2 (MoT physical-security + Atlantis Accord) + 1 (MoT substrate-evolution) + 1 (MoT component-serialization) = 22. Any future domain must fit within these; if not, the substrate is extended (never forked).
