...
Explored by a 24-agent Fable-5 deliberation (IRS/SEC/FinCEN examiner lenses). **DESIGN HYPOTHESIS — PRIMARY-SOURCE-SUPPORTED; a multi-agent deliberation is not legal counsel. Counsel qualification required before live use.** The living document
...
| **TOK-31** | **🏠 Home Continuity Bonus** — housing sub-rail. W-2 supplemental-wage bonus DESIGNED to vest at closing (§83) and pay in the §409A short-term-deferral window (actual forfeiture/timing counsel-reviewed), wired to the closing agent, papered as Employer-Assisted Housing (EAH) so FNMA/FHA accept the source; lender/underwriting + CFPB source-of-funds are independent gates. Lease-to-own accrues a purchase-price credit (real-property interest), never a cash-redeemable balance. **Recognition gates the Bonus, never the bed** (a hub bed is role/§119, not points). | Cube 14 Payments + Cube 8 · lender partners | GAP: EAH program record; §83 vest-at-event; §409A window enforcement; rent-credit/shared-equity ledger; CLT/limited-equity-coop wrapper kept community-wide (not work-gated). |
| **TOK-32** | **Two-Track Tax Doctrine** — Track 1: §119 Employer-Provided Lodging/Meals hub (entity/SPV OWNS the home, on business premises, employer convenience, condition of employment, **NO cash-in-lieu ever**, W-2 only; §119(c) foreign-camp ONLY where its remote-area / housing-unavailable / proximity / common-area / ≥10-employee tests independently hold — rotation alone does not qualify; vehicles/phones/food classified separately under §132/etc.). Track 2: taxed cash (웃 = W-2, withheld first; Livelihood Direct = post-tax routing). A full no-tax cash redirect is NOT lawful (§134 is statute-only) — the §119 hub + taxed cash is the honest BAH/BAS-equivalent DESIGN; qualification is fact-specific and counsel-gated, never automatic. | Cube 5 (classify) · Cube 14 · `hi_rates.py` | GAP: hub §119-file (three prongs) or default to taxable in-kind at FMV on W-2; vehicle personal-use imputed at ALV; §274(o) meal-deduction cost noted. |
