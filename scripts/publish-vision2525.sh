...
DL="frontend/public/whitepaper/SOI_VISION2525_v.18_LIVING_DOCUMENT.html"
...
echo "  download /whitepaper/SOI_VISION2525_v.18_LIVING_DOCUMENT.html  (Content-Disposition: attachment via _headers)"
