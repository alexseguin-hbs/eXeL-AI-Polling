...
// result.unity_tokens_earned → 5.0`, evidence: "Krishna tested with 45 responses across 11 languages. All correctly themed within 200ms. The same multilingual engine powers a bilingual side-by-side reader with 4,436-word dictionary and hover-sync word matching.", liveDemo: "/divinity-guide" },
                      ...
                      <details className="mt-1">
                        ...
                        {demo.liveDemo && (
                          <Link href={demo.liveDemo} className="mt-2 inline-flex items-center gap-1 text-xs hover:underline" style={{ color: currentTheme.swatch }}>
                            <span>↗</span> See it live: {demo.liveDemo}
                          </Link>
                        )}
                      </details>
                    </div>
