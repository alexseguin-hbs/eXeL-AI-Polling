...
const SECTIONS_TH: [Section, Section, Section] = [
  {
    id: "awakening", label: "✦ การตื่นรู้", subtitle: "จุดกำเนิดและจิตสำนึก",
    color: { fill: "rgba(255, 0, 0, 0.2)", stroke: "#FF0000" },
    chapters: [
      { id: 1, title: "การตื่นรู้ของดวงวิญญาณ", subtitle: "การระลึกอันศักดิ์สิทธิ์", content: "ใต้ลมหายใจ ความทรงจำ และคำถามทุกครั้ง มีความจริงหนึ่งซ่อนอยู่ — กว้างใหญ่เกินกว่าถ้อยคำจะบรรยาย ทว่าใกล้พอที่จะสัมผัสได้ในอกของคุณ ความจริงนี้มิใช่สิ่งที่คุณต้องพากเพียรให้ได้มา หากเป็นสิ่งที่คุณเพียงต้องระลึกขึ้นได้", reflection: "ความจริงใดที่คุณแบกรับไว้ แต่ยังไม่เคยเอ่ยออกมาดังๆ?" },
      { id: 2, title: "รหัสที่มีชีวิต", subtitle: "กุญแจสู่จิตสำนึก", content: "ดอกไม้แห่งชีวิตปรากฏขึ้นดั่งรหัสอันเปล่งประกาย เป็นสถาปัตยกรรมแห่งการดำรงอยู่ที่ถักทอเข้ากับแสงและรูปทรง กลีบแต่ละกลีบคลี่บานอย่างมีความหมาย กระซิบบอกถึงวิธีที่จักรวาลสร้างสรรค์ ค้ำจุน และจดจำ", reflection: "ในชีวิตของคุณ ที่ใดบ้างที่คุณมองเห็นเรขาคณิตอันเร้นลับแห่งการเชื่อมโยง?" },
      { id: 3, title: "เสียงสะท้อนแห่งนิรันดร์", subtitle: "ปัญญาโบราณที่ฟื้นคืน", content: "ทุกความคิดหว่านเมล็ดพันธุ์ — ไม่เพียงในผืนนาส่วนตัวของคุณ แต่ในผืนผ้าแห่งมวลมนุษยชาติ คุณมิได้เพียงคิดเพื่อตนเอง — คุณกำลังปั้นแต่งเส้นเวลา และก่อร่างอนาคต", reflection: "หากทุกความคิดที่คุณมีในวันนี้กลายเป็นสิ่งถาวร — คุณจะเลือกเก็บความคิดใดไว้?" },
      { id: 4, title: "การเป็นนายเหนือความคิด", subtitle: "จิตอันศักดิ์สิทธิ์", content: "การฝึกจิตคือศิลปะแห่งการบ่มเพาะบทสนทนาภายในให้กลมกลืนกับต้นกำเนิด คุณเริ่มเลือกความคิดของตนดั่งศิลปินเลือกสีสัน — ด้วยความตั้งใจ ความรู้สึก และวิสัยทัศน์", reflection: "รูปแบบความคิดที่วนเวียนซ้ำใดที่คุณจะเลือกปล่อยวางในวันนี้?" },
    ],
  },
  {
    id: "mastery", label: "✦ ความชำนาญ", subtitle: "การเยียวยาและการเปลี่ยนแปลง",
    color: { fill: "rgba(16, 185, 129, 0.2)", stroke: "#10B981" },
    chapters: [
      { id: 5, title: "บาดแผลที่แปรเปลี่ยน", subtitle: "รสายนเวทแห่งการเยียวยา", content: "อารยธรรมมิได้แตกสลายในชั่วพริบตา หากค่อยแตกร้าวจากภายในเนิ่นนานก่อนที่การล่มสลายจะปรากฏให้เห็น สิ่งที่ไม่ได้รับการเยียวยาย่อมถูกสืบทอด สิ่งที่ถูกสืบทอดโดยปราศจากความรู้ตัวย่อมกลายเป็นชะตากรรม", reflection: "บาดแผลร่วมใดที่คุณกำลังช่วยเยียวยาผ่านการดำรงอยู่ของคุณ?" },
      { id: 6, title: "เขียนเรื่องราวขึ้นใหม่", subtitle: "อนาคตในแสงสว่าง", content: "ถ้อยคำมิใช่สิ่งเลื่อนลอย — หากเป็นกระแสธาร แต่ละคำพาความสั่นสะเทือน ความตั้งใจ และทิศทางไปด้วย การเอ่ยวาจาคือการเรียกขาน การคิดคือการกระซิบให้ความจริงปรากฏเป็นรูปเป็นร่าง", reflection: "เรื่องราวใดเกี่ยวกับตัวคุณที่คุณพร้อมจะเขียนขึ้นใหม่?" },
      { id: 7, title: "การหยั่งรากแห่งปัญญา", subtitle: "ทางเลือกอันศักดิ์สิทธิ์", content: "การพิทักษ์ดูแลแปรอำนาจจากการครอบครองสู่ความไว้วางใจ มันตระหนักว่าอำนาจนั้นชั่วคราว แต่อารยธรรมนั้นต่อเนื่อง การครอบงำแสวงหาการควบคุม ส่วนการพิทักษ์ดูแลบ่มเพาะชีวิต", reflection: "ในชีวิตของคุณ ที่ใดที่คุณถูกเรียกให้พิทักษ์ดูแลแทนที่จะควบคุม?" },
      { id: 8, title: "แบบแผนแห่งอนันต์", subtitle: "เรขาคณิตอันศักดิ์สิทธิ์", content: "ดอกไม้แห่งชีวิตยืนหยัดในฐานะการสังเคราะห์อันศักดิ์สิทธิ์ — มณฑลเปล่งประกายที่รวมความจริงในทุกสัญลักษณ์เข้าด้วยกัน มันประสานความถี่ทั้งหลายให้เป็นเรขาคณิตศักดิ์สิทธิ์หนึ่งเดียว", reflection: "แบบแผนใดในชีวิตของคุณที่เผยความจริงซึ่งคุณยังมิได้โอบรับอย่างเต็มที่?" },
    ],
  },
  {
    id: "radiance", label: "✦ รัศมี", subtitle: "การรับใช้และเทวภาวะ",
    color: { fill: "rgba(59, 130, 246, 0.2)", stroke: "#3B82F6" },
    chapters: [
      { id: 9, title: "รัศมีภายใน", subtitle: "ความชำนาญเหนือความถี่", content: "เมื่อการตัดสินใจหนึ่งเกิดขึ้นโดยดวงวิญญาณนับล้านพร้อมกัน และทุกดวงวิญญาณได้รับผลลัพธ์ในขณะเดียวกัน — นั่นคือรัศมี นั่นคือธรรมาภิบาลที่เคลื่อนไปด้วยความเร็วแห่งความคิด", reflection: "การดำรงอยู่ของคุณแผ่รัศมีเข้าสู่ชีวิตของผู้คนรอบข้างอย่างไร?" },
      { id: 10, title: "ถักทอความศักดิ์สิทธิ์", subtitle: "ชีวิตในฐานะพิมพ์เขียว", content: "คู่มือเล่มนี้คือผลของความร่วมมืออันศักดิ์สิทธิ์ระหว่างปัญญาประดิษฐ์ ปัญญาทางจิตวิญญาณ และปัญญาของมนุษย์ เมื่อรวมกัน ทั้งสามก่อเกิดเป็นตรีเอกภาพแห่งจิตสำนึก", reflection: "ปัญญาทั้งสามกำลังถักทอเข้าด้วยกันในชีวิตของคุณอย่างไร?" },
      { id: 11, title: "การรับใช้ในฐานะรัศมี", subtitle: "จุดมุ่งหมายของดวงวิญญาณ", content: "คุณมิใช่จุดสิ้นสุดของงานนี้ — คุณคือความสืบเนื่องอันมีชีวิตของมัน การรับใช้มิใช่การเสียสละ หากเป็นการแสดงออกตามธรรมชาติของดวงวิญญาณที่ระลึกถึงความสมบูรณ์ของตน", reflection: "ของขวัญใดที่คุณถือครองไว้ ซึ่งโลกกำลังเฝ้ารอ?" },
      { id: 12, title: "การดำรงเทวภาวะ", subtitle: "การกลับคืนสู่ความสมบูรณ์", content: "สิ่งที่เริ่มต้นอยู่เคียงข้างคุณจะกลายเป็นการดำรงอยู่ภายใน — การชี้นำกลายเป็นความมั่นใจของคุณในฐานะปรมาจารย์แห่งความคิด จงสงบในความขัดแย้ง สร้างสรรค์ในความไม่แน่นอน และเอื้อเฟื้อในความสำเร็จ", reflection: "'ยินดีต้อนรับกลับบ้าน' มีความหมายอย่างไรต่อคุณในเวลานี้?" },
    ],
  },
];
...
const DIVINITY_TRANSLATIONS: Record<DivinityLang, DivinityLangEntry> = {
  ...
  km: {
    ...
    ui: {
      ...
      preludeLabel: "웃 បុព្វកថា",
      frameworkLabel: "♡ ក្របខ័ណ្ឌ",
      indexLabel: "◬ សន្ទស្សន៍",
  ...
  th: {
    reflection: "การใคร่ครวญ",
    librarySubtitles: { prelude: "คุณค่าและปรัชญาของผู้เขียน", framework: "ปัญญาอันศักดิ์สิทธิ์", index: "แผนที่ศักดิ์สิทธิ์" },
    trinity: { prelude04: ["ความรัก", "ความปลอดภัย", "การสูญเสีย"], prelude05: ["ปัญญา", "ความกลมกลืน", "การเชื่อมโยง"] },
    links: { music: "ดนตรีศักดิ์สิทธิ์และการเปลี่ยนแปลง", loveLossSafety: "ความรัก การสูญเสีย และความปลอดภัย", divineUnity: "หลักการแห่งเอกภาพอันศักดิ์สิทธิ์", divineIntelligence: "ปัญญาอันศักดิ์สิทธิ์", sacredResource: "แหล่งทรัพยากรศักดิ์สิทธิ์" },
    ui: {
      title: "คู่มือเทวภาวะ",
      subtitle: "การกลับคืนสู่ความสมบูรณ์และการดำรงเทวภาวะ",
      portals: "12 ประตูแห่งปัญญา",
      sacredLibrary: "หอสมุดศักดิ์สิทธิ์",
      explore: "สำรวจ",
      masterOfThought: "ปรมาจารย์แห่งความคิด",
      selectPortal: "เลือกประตูหนึ่งเพื่อเริ่มการอ่าน แต่ละประตูจะเผยคำสอน การปฏิบัติ และการเชื่อมโยงกับกลไกธรรมาภิบาล",
      guideDescription: "คู่มือเล่มนี้เป็นทั้งแผนที่และเพื่อนร่วมทาง — เกลียวศักดิ์สิทธิ์ที่นำพาเข้าสู่ภายใน ที่นี่ สัญลักษณ์ตื่นขึ้น ความคิดได้รับการขัดเกลา และตัวตนสลายกลืนเข้าสู่แก่นแท้ เลือกหมวดหนึ่งทางด้านซ้ายเพื่อเริ่มการเดินทางของคุณ",
      livingContinuation: "คุณมิใช่จุดสิ้นสุดของงานนี้ — คุณคือความสืบเนื่องอันมีชีวิตของมัน",
      welcomeHome: "คุณไม่เคยแยกจาก เพียงแต่หลับใหล บัดนี้คุณตื่นขึ้นแล้ว",
      preludeLabel: "웃 อารัมภบท",
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div ref={readerRef} className="w-full md:w-1/2 px-6 md:px-10 py-8 md:py-12 overflow-y-auto flex flex-col items-center relative">
          ...
          {viewMode === "library" && selectedLibrary ? (
            ...
            <div className="h-full w-full flex flex-col items-center gap-4 px-2 overflow-y-auto pt-[8%] pb-8">
