...
await A.locator('[data-testid^="member-gps-fix-"]').first().waitFor({ timeout: 10000 }); const GPS_RE = new RegExp(`GPS Location ${esc(IN.gps.latitude.toFixed(4))}, ${esc(IN.gps.longitude.toFixed(4))} ±25 m`);
