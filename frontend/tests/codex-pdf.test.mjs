...
const p2 = await stampCodexBlock(p1, { total: 2, rows, all: codexImage(codexAllText(rows, "UTC")), initials: { total: 2, mine: { idx: 1, pngDataUrl: png1x1 }, topByPage: { 1: 0.95, 2: 0.9 } } });
...
const p3 = await stampCodexBlock(await stampCodexBlock(pdf, { total: 2, rows: [rows[0]], all: codexImage(codexAllText([rows[0]], "UTC")), initials: { total: 2, mine: { idx: 0, pngDataUrl: png1x1 }, topByPage: { 1: 0.93, 2: 0.93 } } }), { total: 2, rows, all: codexImage(codexAllText(rows, "UTC")), initials: { total: 2, mine: { idx: 1, pngDataUrl: png1x1 }, topByPage: { 1: 0.80, 2: 0.80 } } });
