...
const EN_ATTACH = 'SOI_VISION2525_v.18_LIVING_DOCUMENT.html" download="SOI_VISION2525_v.18_LIVING_DOCUMENT.html"';

// English canonical: exists and downloads the canonical attachment
const en = readFileSync(`${DIR}vision-2525.html`, "utf8");
ok(en.includes(EN_ATTACH), "EN page downloads the canonical English attachment");
ok(existsSync(`${DIR}SOI_VISION2525_v.18_LIVING_DOCUMENT.html`), "canonical attachment file exists");
...
for (const lc of LANGS) {
  ...
  const own = `vision-2525.${lc}.html" download="SOI_VISION2525_v.18_${lc}.html"`;
