...
{ const f = (844 * 0.52) / Math.tan((38 / 1) * Math.PI / 180); const px300 = (1.016 / 300) * f; const px50 = (0.533 / 50) * f; ok(px300 < 8 && px50 < 12, `a 300 m E is ${px300.toFixed(1)} px tall and a 50 m F ${px50.toFixed(1)} px at 1× — small, as the photographs show; the 3 mrad floor (${(f * 3 / 1000).toFixed(1)} px) keeps them hittable`); }
