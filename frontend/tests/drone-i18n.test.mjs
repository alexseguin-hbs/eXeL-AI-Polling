...
const FILES = ['components/drone-2525/command-ux1.tsx', 'components/drone-2525/arena-view.tsx', 'components/drone-2525/wire-svg.tsx'];
...
ok(droneKeys.length >= 12, `the drone group carries its keys (${droneKeys.length})`);
