...
const FILES = ['components/drone-2525/command-ux1.tsx', 'components/drone-2525/arena-view.tsx', 'components/drone-2525/wire-svg.tsx', 'components/drone-2525/turret-game.tsx'];
...
ok(droneKeys.length >= 25, `the drone group carries its keys (${droneKeys.length})`);
