...
ok(/id:'C-100C'/.test(src) && !/C-250B/.test(src) && /id:'C-50L'/.test(src) && /id:'C-50',pos:'50M F',x:3/.test(src), 'the eleven silhouettes follow the 9127 sheet plus the operator\'s 50 L/R (100 m ×3, one 250, one 300, 50 left and right)');
