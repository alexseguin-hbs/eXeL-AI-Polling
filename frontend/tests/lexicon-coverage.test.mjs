...
const AFTER_FILL = new Set(["pollui.ranked_themes", "pollui.desc_length", "pollui.tier_locked"]);   // 2026-09-14 polling-results UI: English fallback until the next translation batch (listed, never silent)
