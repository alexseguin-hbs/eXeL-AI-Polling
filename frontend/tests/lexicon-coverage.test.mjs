...
const AFTER_FILL = new Set(["soi.qis.formula", "soi.qis.lead", "soi.qis.r_def", "soi.qis.gp_def", "soi.qis.oi_def", "soi.qis.rd_def", "soi.qis.formula_note", "soi.qis.growth", "soi.qis.growth_note", "soi.qis.example_title", "soi.qis.example_start", "soi.qis.example_now", "soi.qis.example_delta", "soi.qis.firewall"]);   // 2026-09-12 morning keys: English until the second fill pass lands (listed, never silent)   // keys added after the last fill pass: English until the next pass — listed here, never silent
