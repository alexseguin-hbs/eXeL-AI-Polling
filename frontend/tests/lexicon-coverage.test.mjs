...
const AFTER_FILL = new Set([
  ...
  'drone.deck.voice_on',
  'drone.deck.voice_off',
  'drone.deck.no_mic',
  'drone.deck.heard',
  'drone.deck.voice_help',
  'drone.deck.tap_help',
  'drone.deck.settings',
  'drone.deck.sens_l',
  'drone.deck.sens_r',
  'drone.deck.dead',
  'drone.deck.zero',
  'drone.deck.from_stick',
  'drone.deck.reset',
  'drone.deck.keymap',
  'drone.deck.print',
  'drone.deck.act.body.forward',
  'drone.deck.act.body.back',
  'drone.deck.act.body.strafe-left',
  'drone.deck.act.body.strafe-right',
  'drone.deck.act.head.tilt-up',
  'drone.deck.act.head.tilt-down',
  'drone.deck.act.head.pan-left',
  'drone.deck.act.head.pan-right',
  'drone.deck.act.yaw.left',
  'drone.deck.act.yaw.right',
  'drone.deck.act.climb.up',
  'drone.deck.act.climb.down',
  'drone.deck.act.target.cycle',
  'drone.deck.act.target.slot-1',
  'drone.deck.act.target.slot-2',
  'drone.deck.act.target.slot-3',
  'drone.deck.act.approve',
  'drone.deck.act.fire',
  'drone.deck.act.capture',
