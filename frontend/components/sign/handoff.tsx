  ...
  return (
    <div className="rounded-lg border border-cyan-400/40 bg-cyan-400/5 p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        {kind === "email"
          ? <button type="button" onClick={sendFromExel} disabled={mailState === "sending" || mailState === "sent"} className="min-h-[44px] rounded-md border border-border px-4 py-2 text-sm disabled:opacity-60" data-testid="send-email">{mailState === "sent" ? t("soi.sign.handoff.mail_sent") : mailState === "sending" ? t("soi.sign.handoff.mail_sending") : t("soi.sign.handoff.mail")}</button>
