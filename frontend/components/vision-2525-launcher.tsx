...
export function Vision2525Launcher() {
  ...
  const domains: CubeDomain[] = [
    ...
    // ⚠ THE "VISION HUB" TILE WAS REMOVED, NOT LOST (operator). /vision-2525 is the public manifesto and
    // now lives in Settings directly under Atlantis Accords, where anyone can reach it without knowing a
    // theme-click sequence. The other tiles stay: they are the ONLY way into SIM, Security and Architect,
    // so deleting the launcher itself would have taken those with it.
