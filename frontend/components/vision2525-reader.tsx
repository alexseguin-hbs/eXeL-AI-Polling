 ...
 *
 * Rendered by BOTH /Vision-2525 and /main/Vision-2525 so either URL works — one component, two
 * doors, no second copy to drift.
 *
...
import { Download, Sun, Moon, ExternalLink, Sparkles, User } from "lucide-react";
