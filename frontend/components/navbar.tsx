              ...
              <section>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { num: "3", name: "convert", icon: "웃", tagline: "Value human time", desc: "1 hour of work = 7.25 웃 — same rate on every continent", cost: "Free", demo: "const tokens = await sdk.convert({ hours: 1 });\n// → 7.25 웃 · time-denominated, pegged to no currency" },
