...
export function HomeLauncher() {
  ...
  if (!ready || isLoading || !isAuthenticated || dismissed) return null;

  const domains: CubeDomain[] = [
    { id: "polling", code: "POLLING", name: "eXeL AI POLLING", tagline: "Govern at the Speed of Thought", color: currentTheme.swatch || "#19C8CF", unlocked: true, onEnter: dismiss },
