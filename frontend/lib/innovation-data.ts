...
export interface Project {
  ...
  provenance?: string;
  /** PRJ-34 v1.0 (operator 2026-09-24 · evidence law) · when set, the Pod prints THIS sentence wherever the template would
   *  derive money (header COGS / MSRP / margin · S1 positioning chart · S2 / S3 return profile · S8 value charts · S10 grid).
   *  Content, not chrome: the row authors the sentence, so no derived figure ever reaches a founder who was promised none. */
  unpriced?: string;
...
export const PROJECT_BRIEF: Record<string, ProjectBrief> = {
  ...
  "PRJ-34": {
    needs: ["One governed environment for strategic judgment and coordinated leadership action across reputation, operations, legal, regulatory, financial, safety and stakeholder domains", "Faster time to coherent, approved leadership action, with a traceable record of what was known, decided, owned and what happened next"],
    outcomes: ["Explicit decision rights and approval state", "Action ownership, acknowledgement and evidence tied to the strategic record", "Formal versioned current-plan state", "Outcome-linked replay and risk / outcome simulation"],
    solution: ["One platform: the governed leadership record (decision rights · approval · ownership · acknowledgement · evidence · current plan · replay) plus, by qualification, every aspect of the benchmark's job (Everbridge 360 AI / Bridge)", "Absorb by the R-CORE ladder: every benchmark function reachable from inside the platform in 2027, native by 2030 after each beats the benchmark on its clock by the one-ninth gate, alerting last and certified; Rave and PagerDuty as inbound feeds", "Pro Team → Pro Enterprise commercial spine only"],
    evidence: ["EDU → FOOD → TECH validation sequence (not a TAM rank); one primary NBA each — Rave · Everbridge 360 AI / Bridge · PagerDuty", "G2 pre-registered EDU tabletop proves the measurement design; G3 instrumented benchmark-alone vs one-platform A/B proves value", "S16 validation matrix as change-control; no price until WTP is customer-sourced"],
  },
...
export function customerOf(p: Project): string {
  ...
  if (/crisis|resilience|crisiscommand/.test(d)) return "Leaders under pressure · EDU · FOOD · TECH (Pro Team / Pro Enterprise)"; // PRJ-34 (v0.8.2, not DoD)
...
const DEMO_PROJECTS_BASE: Project[] = [
  ...
  //    2026-09-24 v0.8.2: the future-state product is CrisisCommand.ai; v0.4 / v0.5 archived; NO v0.5 dollar is current. nreK = a DECLARED
  ...
  nreK: 11200, fullRev10yM: 248, doNothing10yM: 0, firstRevenue: "2027-Q3", criticalPath: false, humanLoad: 0.5, ai: 0.3, si: 0.2, hi: 0.5, predictions: 0, startDate: "2026-09-23",
    provenance: "Human-authored strategy · AI-assisted synthesis by eXeL AI · cross-review informed by Grok · twelve-lens review 2026-09-24 · final authority: De-Risking Strategies / Human Intelligence · v1.0 · rev 0.098" },
...
const PROJECT_INTEL: Record<string, ProjectIntel> = {
  ...
  "PRJ-34": {
    // v1.0 ONE PLATFORM (operator 2026-09-24 + the twelve-lens review) — the master statement is the DRS master's
    // futureState.master.statement, mirrored verbatim; drs-render + innovation-time assert the two never drift. The platform
    // benchmark is Everbridge 360 AI / Bridge (eleven of twelve lenses); Rave (EDU) and PagerDuty (TECH) are segment comparators
    // and inbound feeds. No dollar is current: the row is typed `unpriced`, the waterfall bars are 0, nothing is derived.
    ...
    segmentValueProps: [
      { segment: "EDU · Distributed Institutional Trust & Governance (comparator Rave · benchmark Everbridge 360 AI / Bridge)", prop: "Rave protects and communicates with the campus today; in the one platform, CrisisCommand.ai carries that reach under named authority — leadership decides what the institution will do, why, who owns it, and every message leaves from the approved posture.", pain: "where the NBA stops: executive decision rights and cabinet alignment; governance interpretation and stakeholder tradeoffs; approved institutional posture with action ownership and approval / rationale provenance; board / parent / faculty / donor strategy and outcome-linked replay", outcome: "Minimise minutes from event recognition to one approved institutional posture — baseline TBD, target: improve (signature outcome, v0.9 S5) · Reduce consequential strategy / message revisions — baseline TBD, target: reduce · One approved institutional posture across president, cabinet, legal, communications and operational leadership — research: Outcome-Driven Innovation, Kano classification, FEMA HSEEP", confidence: 2 },
      { segment: "FOOD · Product Safety, Recall & Consumer Trust (benchmark Everbridge 360 AI / Bridge)", prop: "Everbridge 360 AI / Bridge is the benchmark: CrisisCommand.ai carries the critical-event and continuity job inside one governed record, so enterprise judgment, approval and the response to customers, regulators and franchisees are one platform, never two.", pain: "where the NBA stops: enterprise severity judgment and brand / legal / regulatory tradeoffs; executive decision rights and stakeholder strategy across customers / regulators / franchisees / employees / investors; approval provenance and one approved enterprise posture; action / message synchronization and outcome-linked replay", outcome: "Minimise time from material product fact to approved enterprise severity and stakeholder posture — baseline TBD, target: improve (signature outcome, v0.9 S7) · Reduce conflicting approved versions across regulator / customer / franchisee posture — baseline TBD, target: reduce · One enterprise posture from affected product / unit facts to customer and regulator trust decisions — research: Outcome-Driven Innovation, Kano classification, ISO 22301 Business Impact Analysis", confidence: 2 },
      { segment: "TECH · Digital Revenue & Trust Under Technical Pressure (comparator PagerDuty · benchmark Everbridge 360 AI / Bridge)", prop: "PagerDuty runs the technical incident and stays an inbound feed; CrisisCommand.ai runs leadership's response to what it means and carries the stakeholder-update half natively — never claiming restoration minutes.", pain: "where the NBA stops: the enterprise meaning of the technical event — reputation / legal / regulatory / financial exposure; executive options, tradeoffs and decision rights; approval provenance, customer / regulator / investor posture and a board-ready current strategy; action ownership outside the technical response and outcome-linked replay", outcome: "Minimise time from technical severity established to approved executive / customer / regulator posture — baseline TBD, target: improve (signature outcome, v0.9 S9) · Reduce major revisions / contradictory customer, investor and regulator versions — baseline TBD, target: reduce · Never claim CrisisCommand reduces technical outage duration unless causality is proven — the leadership clock only — research: Outcome-Driven Innovation, Kano classification, FEMA HSEEP", confidence: 2 },
    ],
  },
};
