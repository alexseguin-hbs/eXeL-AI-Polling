...
const PROJECT_INTEL: Record<string, ProjectIntel> = {
  ...
  "PRJ-34": {
    // 0.005 · FUTURE STATE FOR CRISISCOMMAND.AI (operator 2026-09-24) — the master statement is DERIVED in docs/drs/drs.v00.00.json
    // `futureState` (where each NBA stops × the needs-based segment research) and mirrored here verbatim; drs-render asserts it.
    valueProp: "CrisisCommand.ai, future state: the human-directed coordination layer that begins where GridOS, Veoci and Sentinel stop \u2014 verified authority, needs and resources as objects, recipient fulfillment, plan provenance, replay into the next event \u2014 built for three needs-based segments and proven only by a measured delta beside each segment's NBA.",
    ...
    segmentValueProps: [
      { segment: "Utility / industrial (\u2194 GridOS)", prop: "For the utility or plant whose NBA already owns restoration math and crews, CrisisCommand.ai coordinates the envelope Storm Manager does not hold \u2014 shelter, heat, water, fuel, medical dependence, civic identity, recipient trace \u2014 so a recorded need reaches a verified assignment in hours, not shifts.", pain: "where the NBA stops: community and plant envelope: shelter, heat / cool, water, non-store fuel, medical dependence; civic and volunteer identity beyond the crew roster; recipient trace and the public / large-customer plan card", outcome: "Minimise the time from a recorded community or plant need to a verified assignment \u2014 baseline 8\u201318 h, target \u2264 2 h (IA) \u00b7 Minimise unresolved priority needs at T+24h \u2014 \u2264 15 % (IA) \u00b7 Maximise plan-card acknowledgement by named officials \u2014 \u2265 80 % within 30 min (IA) \u2014 research: Outcome-Driven Innovation, FEMA THIRA / SPR, CDC CASPER", confidence: 2 },
      { segment: "Healthcare / regional (\u2194 Veoci Vitals EM)", prop: "For the regional health system whose NBA already runs HICS, the 96-hour view and the AAR, CrisisCommand.ai coordinates the regional non-clinical exchange and the public card under named cross-organizational authority \u2014 never HICS, never PHI.", pain: "where the NBA stops: regional non-clinical resource exchange across organizations; affected-population transparency distinct from internal HICS traffic; verified cross-organizational authority when ICS structures disagree; replay across events, beyond the accreditation AAR", outcome: "Minimise minutes to a multi-organization authority picture \u2014 \u2264 25 min from activation (IA) \u00b7 Minimise distinct public-message versions in the first 12 hours \u2014 \u2264 2 (IA) \u00b7 Minimise volunteer time to a qualified assignment \u2014 \u2264 4 h (IA) \u2014 research: Outcome-Driven Innovation, UN OCHA MIRA, FEMA HSEEP", confidence: 2 },
      { segment: "Campus / fixed site (\u2194 YUDU Sentinel)", prop: "For the campus whose NBA already notifies in under 60 seconds and convenes, CrisisCommand.ai fulfills and accounts \u2014 who lacks heat, which building has capacity, who has blankets, who is qualified, who approved relocation, who received assistance \u2014 never the blast, the check-in or the video room.", pain: "where the NBA stops: fulfillment and account-for after the notification; individual needs, shelter and welfare intake; allocation of blankets, water, heat, transport, facility capacity; plan provenance, three resource plans, the degraded-mode cache / bridge", outcome: "Minimise minutes to 90 % of a known population accounted for \u2014 \u2264 40 min (IA) \u00b7 Minimise need-to-fulfillment for heat, water and blankets \u2014 \u2264 90 min median (IA) \u00b7 Cut duplicate emergency-labour hours versus the last comparable event \u2014 \u221225 % (IA) \u2014 research: Outcome-Driven Innovation, CDC CASPER, Kano classification", confidence: 2 },
    ],
  },
};
