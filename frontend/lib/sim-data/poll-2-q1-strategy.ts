...
export const POLL_2 = {
  ...
  themeLevels: {
    theme2_9: [
      { id: "t1", name: "Revenue Growth Strategy", confidence: 0.93, count: 6, color: "#10B981", partition: "Supporting Comments" },
      { id: "t2", name: "Geographic Expansion", confidence: 0.88, count: 4, color: "#059669", partition: "Supporting Comments" },
      { id: "t3", name: "Strategic Partnerships", confidence: 0.86, count: 3, color: "#047857", partition: "Supporting Comments" },
      { id: "t4", name: "Customer Success Investment", confidence: 0.85, count: 3, color: "#34D399", partition: "Supporting Comments" },
      ...
      { id: "t7", name: "Product Innovation", confidence: 0.81, count: 3, color: "#34D399", partition: "Supporting Comments" },
    ...
    theme2_6: [
      { id: "t1", name: "Revenue & Market Growth", confidence: 0.92, count: 8, color: "#10B981", partition: "Supporting Comments" },
      { id: "t2", name: "Partnerships & Expansion", confidence: 0.87, count: 6, color: "#059669", partition: "Supporting Comments" },
      ...
      { id: "t5", name: "Customer Success", confidence: 0.85, count: 5, color: "#047857", partition: "Supporting Comments" },
      { id: "t6", name: "Team & Culture Health", confidence: 0.78, count: 4, color: "#3B82F6", partition: "Neutral Comments" },
    ],
    theme2_3: [
      { id: "t1", name: "Revenue & Growth", confidence: 0.93, count: 16, color: "#10B981", partition: "Supporting Comments" },
