...
// Mood palette — 3 themes for the Flower of Life visualization.
// Colors mirror Cube 7 Theme01 conventions used across dashboard & divinity guide.
export const MOOD_PALETTE: Record<
  MoodTheme,
  { label: string; stroke: string; fill: string; hub: string }
> = {
  risk: {
    label: "Risk & Concern",
    stroke: "#FF3B3B",
