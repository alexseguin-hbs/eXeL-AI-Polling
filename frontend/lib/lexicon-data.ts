...
const experiences: TranslationEntry[] = [
  ...
  { key: "experiences.egg.soi.blurb", englishDefault: "The System of Innovation on this very platform: an AI-directed portfolio governance engine that drills a company P&L from BU to Alpha Code, seeds Rev/Margin/Growth, and prioritizes an innovation stack in real time — designed to Innovate at the Speed of Thought. Grounded in real portfolio subject-matter expertise across BASF (advanced materials & coatings), Honeywell (industrial automation & sensing), and FLIR (thermal imaging & sensor fusion). ~8 hrs of AI-directed coding · Value: ~$22K for a comparable custom build.", context: "Card blurb: System of Innovation portfolio-optimization tool", cubeId: 50 },
