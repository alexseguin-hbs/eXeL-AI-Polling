...
const experiences: TranslationEntry[] = [
  ...
  { key: "experiences.sec.writeups.intro", englishDefault: "An executive presentation and technical capability writeup I authored when Deloitte asked me to assess the U.S. Army's IVAS (Integrated Visual Augmentation System, the soldier-worn mixed-reality headset): the AI/ML components required to turn it into a multi-domain platform, sensor fusion, computer-vision detection and tracking, edge-AI inference, and an OODA-loop decision-support model, connecting the headset to ground robots, drones, and edge sensors. The same systems thinking now drives portfolio optimization — an AI-directed governance engine (SoI-2525) built to Innovate at the Speed of Thought, turning intent into governed, decision-ready software.", context: "Section head intro: Presentation & Writeup — depicts IVAS + AI/ML components, plus the SoI-2525 portfolio-optimization work", cubeId: 50 },
  ...
  { key: "experiences.egg.soi.title", englishDefault: "SoI-2525 · Portfolio Optimization", context: "Card title: the SoI-2525 portfolio-optimization tool (this platform)", cubeId: 50 },
  { key: "experiences.egg.soi.badge", englishDefault: "8 hr build · valued ≈ $18K", context: "Card badge: SoI-2525 build effort + estimated comparable build value", cubeId: 50 },
  { key: "experiences.egg.soi.blurb", englishDefault: "The tool on this very platform: an AI-directed portfolio governance engine that drills a company P&L from BU to Alpha Code, seeds Rev/Margin/Growth, and prioritizes an innovation stack in real time — designed to Innovate at the Speed of Thought. ~8 hrs of AI-directed coding, valued at ≈ $18K for a comparable custom build.", context: "Card blurb: SoI-2525 portfolio-optimization tool", cubeId: 50 },
  { key: "experiences.egg.soi.demoLabel", englishDefault: "Interested? View the live demo", context: "SoI-2525 card: reveal toggle for the gated demo access code", cubeId: 50 },
  { key: "experiences.egg.soi.demoCode", englishDefault: "Access code 369963 — open SoI-2525 and enter it to explore the live portfolio deck.", context: "SoI-2525 card: gated demo access code hint", cubeId: 50 },
  { key: "experiences.egg.soi.demoOpen", englishDefault: "Open SoI-2525", context: "SoI-2525 card: open-tool button label", cubeId: 50 },
  ...
  { key: "experiences.card.vid4.blurb", englishDefault: "How this very platform is built: human intent directing AI to ship real, governed software. Worked example — Security-2525's Mission Planning basic tool: ~16 hrs of AI-directed coding, valued at ≈ $24K for a comparable custom build.", context: "Card blurb: AI / Claude Code demo video — Security-2525 Mission Planning tool, 16 hrs, est. build value", cubeId: 50 },
