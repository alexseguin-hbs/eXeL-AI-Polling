...
const cube8: TranslationEntry[] = [
  ...
  { key: "soi.coin.HI.law", englishDefault: "1 웃 = 1 hour at 1× local min wage · earned = hours × M", context: "SoI coin 웃 HI earning rule — the 1×M framework: 1 웃 base = one hour at 1× local minimum wage; earned = hours × M. Keep the 웃 glyph.", cubeId: 8 },
  { key: "soi.coin.HI.baseline", englishDefault: "웃 is a multiple of the minimum-wage hour: 1 웃 (base) = one hour at 1× your local minimum wage, and earned 웃 = hours × M, where M is the qualification multiple (M ≥ 1). Currency-free at minting — the local wage sets the payout only at settlement — with a 9,999 웃/yr annual settlement ceiling (one full-time year).", context: "SoI coin 웃 HI baseline — the 1×M framework: base 1 웃 = 1 hour at 1× local minimum wage, earned = hours × M; currency-free mint; 9,999/yr ceiling. Matches the White Paper denomination. Keep the 웃 glyph.", cubeId: 8 },
