...
const experiences: TranslationEntry[] = [
  ...
  { key: "experiences.sec.writeups.intro", englishDefault: "An executive presentation and technical capability writeup I authored when Deloitte asked me to assess the U.S. Army's IVAS (Integrated Visual Augmentation System, the soldier-worn mixed-reality headset): the AI/ML components required to turn it into a multi-domain platform, sensor fusion, computer-vision detection and tracking, edge-AI inference, and an OODA-loop decision-support model, connecting the headset to ground robots, drones, and edge sensors.", context: "Section head intro: Presentation & Writeup — accurately depicts IVAS + the AI/ML components assessed", cubeId: 50 },
  ...
  { key: "experiences.card.vid4.blurb", englishDefault: "How this very platform is built: human intent directing AI to ship real, governed software.", context: "Card blurb: AI / Claude Code demo video", cubeId: 50 },
