...
const cube8: TranslationEntry[] = [
  ...
  { key: "soi.coin.HI.law", englishDefault: "1 hour of qualified work ≈ 4.807 웃", context: "SoI coin 웃 HI earning rule (keep the 웃 glyph + numbers)", cubeId: 8 },
  { key: "soi.coin.HI.baseline", englishDefault: "Currency-free: 4.807 웃 per hour (9,999 웃 ÷ 2,080 hours = one full-time year, landing exactly on the annual ceiling). The same 4.807 웃 for a qualified hour in every economy — the local minimum wage enters only at settlement, never at minting.", context: "SoI coin 웃 HI baseline — the mint is currency-free at 4.807 웃/hour (9,999÷2,080); the local wage applies only at settlement. Keep the 웃 glyph and the number 4.807. Matches the White Paper (HI_PER_HOUR).", cubeId: 8 },
