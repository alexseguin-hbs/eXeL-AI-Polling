...
const cube8: TranslationEntry[] = [
  ...
  { key: "soi.pod.earns.invite", englishDefault: "Two join by code or QR; all three agree.", context: "Pod page: under the lit chip", cubeId: 8 },
  ...
  { key: "soi.pod.earns.audit", englishDefault: "웃 settle only for hours both others witness.", context: "Pod page: under the lit chip", cubeId: 8 },
  { key: "soi.pod.earns.closed", englishDefault: "♡ hours → 웃 settled · ◬ the 333-word synthesis.", context: "Pod page: under the lit chip", cubeId: 8 },
  ...
  { key: "soi.sign.handoff.template", englishDefault: "{sender} asks you to sign \"{title}\" on eXeL — no account, no fee. Open: {link}", context: "Hand-off: the text/e-mail body; keep {sender} {title} {link}", cubeId: 8 },
