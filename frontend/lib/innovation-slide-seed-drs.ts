...
const PROV = "Human-authored strategy · AI-assisted synthesis by eXeL AI · cross-review informed by Grok · twelve-lens review 2026-09-24 · final authority: De-Risking Strategies / Human Intelligence · v1.0 · rev 0.080";
...
export const SLIDE_SEED_DRS: SlideSeed = {
  "PRJ-34": {
    ...
    S2: {
      status: {
        hi: "G2 / future-state validation · customer-facing product CrisisCommand.ai · internal innovation method De-Risking Strategies / Project 34 · edition v1.0 ONE PLATFORM · rev 0.080 · decision register D1–D82 and the iteration ledger in docs/drs (append-only).",
        ai: "G2 / future-state validation · customer-facing product CrisisCommand.ai · internal innovation method De-Risking Strategies / Project 34 · edition v1.0 ONE PLATFORM (operator 2026-09-24 + the twelve-lens review) over the v0.9 gate manuscript (eXeL) and the v0.9 narrative (Grok); v0.8.2 for S16 / S19 detail; v0.4 / v0.5 retired · rev 0.080 · decision register D1–D82 and the iteration ledger in docs/drs (append-only). " + PROV,
      },
      roadmap: {
        hi: [
    ...
    S18: {
      ...
      e0: {
        hi: [
          ...
          "The decision register (D1–D82) and the iteration ledger travel with the record — every key decision, its revision and its author, replayable.",
        ],
        ai: [
          "End-of-life communication to leadership, crisis team and stakeholders through the approved posture.",
          "The last event's replay carried into the successor: the next crisis does not restart from a blank page.",
