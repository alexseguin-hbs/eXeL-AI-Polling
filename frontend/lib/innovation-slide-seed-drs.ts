...
const PROV = "Human-authored strategy · AI-assisted synthesis by eXeL AI · cross-review informed by Grok · twelve-lens review 2026-09-24 · final authority: De-Risking Strategies / Human Intelligence · v1.0 · rev 0.130";
    ...
    S3: {
      fincomment: {
        hi: [
          ...
          "Ramp (IA): 6 paying accounts in 2027 → 15 · 30 · 60 (2030) → 640 by 2036 (≈ one tenth of the benchmark's installed base) at 60 k (the existing Pro Enterprise tier), then 120 k a year once the benchmark's functions are native (2031+, the platform tier) = 2,121 account-years, 248 M ten-year revenue, 3-year CAGR 2027 → 2030 = 115 %. NPV proxy +1.0 M at the G2 weighting — positive and non-zero, the Pod's demo model. Resources exist for the full eleven years (11.2 M, IA); the return profile, S10 and S14 derive from this record.",
