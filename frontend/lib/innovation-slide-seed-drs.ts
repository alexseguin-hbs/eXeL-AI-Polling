...
const PROV = "Human-authored strategy · AI-assisted synthesis by eXeL AI · cross-review informed by Grok · twelve-lens review 2026-09-24 · final authority: De-Risking Strategies / Human Intelligence · v1.0 · rev 0.037";
...
export const SLIDE_SEED_DRS: SlideSeed = {
  "PRJ-34": {
    ...
    S1: {
      ...
      ask: {
        hi: "G2 ask: approve the three segment teardowns — an NBA is a segment's Next Best Alternative, the primary competitor a buyer would use instead, shown in the market table — with buyer interviews, the EDU measurement-design tabletop, workflow prototypes, segment value equations, CTS discovery and S16 evidence tracking; G3 A/B simulation only after the G2 measurement design is credible.",
        ai: "G2 ask: approve 1 EDU / Rave teardown + buyer interviews + measurement-design tabletop · 2 FOOD / Everbridge 360 AI / Bridge teardown + buyer interviews · 3 TECH / PagerDuty teardown + buyer interviews · 4 future-state workflow prototypes · 5 segment-specific value equations · 6 CrisisCommand-specific CTS discovery · 7 S16-style evidence tracking · 8 G3 A/B simulation only after the G2 measurement design is credible. " + MASTER_Q + " G2 exit: buyer confirms the need · primary NBA confirmed · current-state baseline confirmed · at least two future-state deltas survive comparison · measurable clock defined · economic weight can be sourced · CTS path understood · pilot willingness exists.",
      },
    },
    // ── Pod S2 Project Overview ← v0.9 S2 + S18 ──────────────────────────────────────────────────────────
    S2: {
      status: {
        hi: "G2 / future-state validation · customer-facing product CrisisCommand.ai · internal innovation method De-Risking Strategies / Project 34 · edition v1.0 ONE PLATFORM (operator 2026-09-24 + the twelve-lens review) over the v0.9 gate manuscript (eXeL) and the v0.9 narrative (Grok); v0.8.2 for S16 / S19 detail; v0.4 / v0.5 retired · rev 0.037 · decision register D1–D39 and the iteration ledger in docs/drs (append-only).",
      ...
      toprisks: {
        hi: [
          ...
          "Old DRS resource thesis returns; a new SKU invented before WTP evidence.",
        ...
        ai: [
          ...
          "Old DRS resource thesis returns — physical-resource workflow only if segment evidence proves it; a new SKU invented before WTP evidence — preserve the current commercial spine until validated.",
    ...
    S3: {
      fincomment: {
        hi: [
          "Financial RESET (v0.9 S17): do not reuse old DRS prices, SAM, SOM, NPV, IRR or CTS. New market model: reachable accounts × validated annual value × realistic conversion = serviceable opportunity.",
    ...
    S6: {
      problem: {
        hi: [
          ...
          "Current foundation (do not re-sell as new): the live crisis workflow — facts / objectives · stakeholder analysis · message development · SITREPs · planning · sector intelligence · organization-specific context · continuous learning.",
        ],
        ai: [
          ...
          "Current foundation (do not re-sell as new): structured crisis workflow · facts / intake · objectives · stakeholder analysis · message development · pressure testing · SITREPs · near-term planning · sector intelligence · case / scenario libraries · organization-specific enterprise context · historical / continuous learning.",
    ...
    S14: {
      ...
      ftedollar: {
        hi: [
          ...
          ["TECH clock", "technical severity established → approved executive / customer / regulator posture", "inputs: leadership / legal / comms labor · support surge · advisor burn · attributable / SLA exposure", "never technical restoration minutes"],
        ],
        ai: [
          ...
          ["TECH clock", "technical severity established → approved executive / customer / regulator posture", "inputs: executive / legal / communications labor · support surge · advisor burn · directly attributable transaction / revenue exposure · contractual / SLA exposure where leadership delay matters", "never technical restoration minutes"],
    ...
    S18: {
      ...
      e0: {
        hi: [
          ...
          "The decision register (D1–D39) and the iteration ledger travel with the record — every key decision, its revision and its author, replayable.",
        ],
        ai: [
          "End-of-life communication to leadership, crisis team and stakeholders through the approved posture.",
          "The last event's replay carried into the successor: the next crisis does not restart from a blank page.",
