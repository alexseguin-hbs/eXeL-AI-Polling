...
const CONFIRM = "CONFIRM with CrisisCommand before external use: v0.8.2 and the external narrative pass read Pro Team → Pro Enterprise with six live Industry Knowledge Bases (EDU · FOOD · TECH · RETAIL · HEALTH · FIN); the eXeL v0.9 manuscript reads CORE / PRO / ENTERPRISE with EDU · FOOD · TECH live and Healthcare / Retail / Manufacturing / Finance upcoming.";
const PROV = "Human-authored strategy · AI-assisted synthesis by eXeL AI · cross-review by an external narrative pass · twelve-lens review 2026-09-24 · final authority: De-Risking Strategies / Human Intelligence · v1.0 · rev 0.131";
...
export const SLIDE_SEED_DRS: SlideSeed = {
  "PRJ-34": {
    ...
    S1: {
      ...
      strategy: {
        hi: [
          "Thesis: ONE platform. CrisisCommand.ai carries every aspect of the benchmark's critical-event job inside the governed leadership record.",
          "Validate ten deltas — the ten leadership features itemised on S8. The economic lens stays internal (S14 / S15).",
        ],
        ai: [
      ...
      ask: {
        hi: "Concept-gate ask (Concept · G1): approve the concept and its de-risking plan and advance to Plan. The de-risking plan then runs the three segment teardowns — an NBA is a segment's Next Best Alternative, the primary competitor a buyer would use instead, shown in the market table — with buyer interviews and the segment-validation work itemised in the note, at the forward DRS G2 measurement gate; G3 A/B simulation only after the G2 measurement design is credible.",
        ai: "Concept-gate ask (Concept · G1 — the current ask is to pass the Concept gate and advance to Plan by approving the concept and its de-risking plan; G2 · G3 are the two forward De-Risking Strategies validation gates that run after Concept — G2 approves the measurement design, G3 runs the instrumented A/B): approve the concept and its de-risking plan, whose steps are 1 EDU / Rave teardown + buyer interviews + measurement-design tabletop · 2 FOOD / Everbridge 360 AI / Bridge teardown + buyer interviews · 3 TECH / PagerDuty teardown + buyer interviews · 4 future-state workflow prototypes · 5 segment-specific value equations · 6 CrisisCommand-specific CTS (cost-to-serve — what CrisisCommand spends to serve a customer, the cost a validated price must clear) discovery · 7 S16-style evidence tracking · 8 G3 A/B simulation only after the G2 measurement design is credible. " + MASTER_Q + " G2 exit: buyer confirms the need · primary NBA confirmed · current-state baseline confirmed · at least two future-state deltas survive comparison · measurable clock defined · economic weight can be sourced · CTS path understood · pilot willingness exists.",
      },
    },
    // ── Pod S2 Project Overview ← v0.9 S2 + S18 ──────────────────────────────────────────────────────────
    S2: {
      status: {
        hi: "Concept (G1) · future-state validation · customer-facing product CrisisCommand.ai · internal innovation method De-Risking Strategies / Project 34 · edition v1.0 ONE PLATFORM · rev 0.131 · decision register D1–D133 and the iteration ledger in docs/drs (append-only).",
        ai: "Concept (G1) · future-state validation · customer-facing product CrisisCommand.ai · internal innovation method De-Risking Strategies / Project 34 · edition v1.0 ONE PLATFORM (operator 2026-09-24 + the twelve-lens review) over the v0.9 gate manuscript (eXeL) and the v0.9 narrative (an external narrative pass); v0.8.2 for S16 / S19 detail; v0.4 / v0.5 retired · rev 0.131 · decision register D1–D133 and the iteration ledger in docs/drs (append-only). " + PROV,
      },
      roadmap: {
        hi: [
    ...
    S3: {
      fincomment: {
        hi: [
          ...
          "Ramp (IA): 6 paying accounts in 2027 → 15 · 30 · 60 (2030) → 640 by 2036 (≈ one tenth of the benchmark's installed base) at 60 k (the existing Pro Enterprise tier), then 120 k a year once the benchmark's functions are native (2031+, the platform tier) = 2,121 account-years, 248 M ten-year revenue, 3-year CAGR 2027 → 2030 = 115 %. NPV proxy +1.0 M at the Concept-gate weighting — positive and non-zero, the Pod's demo model. Resources exist for the full eleven years (11.2 M, IA); the return profile, S10 and S14 derive from this record.",
        ...
        ai: [
          "Financial RESET (v0.9 S17): do not reuse old DRS prices, SAM, SOM, NPV (net present value), IRR or CTS. New market model: reachable accounts × validated annual value × realistic conversion = serviceable opportunity.",
          "Financial model — DECLARED (IA — an internal assumption, not buyer-validated): one Pro Enterprise institution (EDU beachhead; FOOD / TECH analogous) · verified 250 $/min (IA) × 90 leadership-delay minutes removed × 4 events a year = 90 k time value · 30 k discrete avoided cost · 60 k risk-adjusted outcome (range midpoint) → 180 k modeled value per customer-year · 33 % capture (the Pod's default capture fraction) → 60 k annual price.",
          "Ramp (IA): 6 paying accounts in 2027 → 15 · 30 · 60 (2030) → 640 by 2036 (≈ one tenth of the benchmark's installed base) at 60 k (inside the existing Pro Enterprise tier), then 120 k a year once the benchmark's functions are native (2031+, the platform tier) = 2,121 account-years, 248 M ten-year revenue, 3-year CAGR (compound annual growth rate) 2027 → 2030 = 115 % — a 10× rise in three years. Resources every year 2026–2036: 11.2 M in total (build 2027–2029, then platform R&D, knowledge base and customer success) — resources exist for the full eleven years (IA). NPV proxy +1.0 M at the Concept-gate weighting (tech med × comm high = 0.18) — positive and non-zero, the Pod's demo model, stated as such; a G3 pass roughly doubles it. The return profile, S10 and S14 derive from this eleven-year record.",
          "Value equation (S14): Verified $/min = direct time-dependent cost ÷ elapsed minutes · Time Value = verified $/min × leadership-delay minutes reduced · Risk-Adjusted Value = (P(loss) (the probability of a loss) before − P(loss) after) × consequence value, ranges only · Modeled Value = Time Value + Discrete Avoided Cost + Risk-Adjusted Outcome Value · Contribution = validated WTP − CrisisCommand-specific CTS.",
          "No price is supported until a buyer validates baseline, delta, economic weight, attribution and willingness to pay.",
    ...
    S4: {
      conops: {
        hi: [
          ...
          "Named action owners.",
          "Stakeholder strategy → synchronized communications → the community answers back (S7 · eXeL Polling API).",
    ...
    S5: {
      problem: {
        hi: "In a high-pressure incident, leaders across many enterprise domains have no governed layer that turns incident context into aligned executive decisions, governed action, coherent stakeholder response and reusable learning. Two systems — one to respond, one to decide — split the record; the future state is one platform.",
      ...
      whys: {
        hi: [
          "EDU: leadership must align safety, governance, legal, communications, reputation and its many campus constituencies while facts keep changing.",
          "FOOD: a product, quality, contamination, recall, supplier, workforce or brand event rapidly crosses many enterprise domains.",
          "TECH: a technical outage, cyber event, data breach, product failure, AI failure or platform incident becomes an enterprise crisis when it creates consequences across many enterprise domains.",
        ...
        ai: [
          ...
          "Upside horizon (IA, 2525 vision — not a shipped or savings claim): the same governed loop — detect → judge → approve → act → replay → improve — turned to critical outcomes and high-upside financial-crisis coordination across the EDU / FOOD / TECH domains, high-stakes scenarios where getting the leadership loop right carries large upside; by 2525 the one human-governed record carries the key features of every major crisis offering, absorbed by qualification (the one-ninth (11.1 %) gate, alerting last and certified); the primary set stays EDU · FOOD · TECH and money stays DECLARED (IA), never buyer-validated.",
        ],
      },
      statusquo: {
        hi: [
          ...
          "Not unique by themselves: common crisis-tool capabilities — itemised in the note.",
        ],
        ai: [
          "EDU — Rave is strong at alert → safety communication → responder / community coordination; CrisisCommand future state: judge → align → approve → govern posture → learn.",
          "FOOD — Everbridge 360 AI / Bridge is strong at risk intelligence → continuity → response workflow → coordinated action → operational improvement; CrisisCommand: enterprise judgment → stakeholder tradeoffs → executive approval → governed posture → outcome-linked replay.",
    ...
    S6: {
      problem: {
        hi: [
          ...
          "Current foundation (do not re-sell as new): the live crisis workflow, itemised in the note.",
        ],
        ai: [
      ...
      conops: {
        hi: [
          "Architecture — 1 Operational Context (INPUT): selected facts / status from the operational systems of record, absorbed by qualification → 2 CrisisCommand (LEADERSHIP GOVERNANCE): the governed leadership record — its Horizon-1 objects itemised on S14 → 3 Execution (OUTPUT): approved actions route to operational systems, tools and human owners → 4 Evidence + Learning (RETURN): the return path back onto the record — its objects itemised on S14.",
          LOOP,
        ],
        ai: [
          ...
          "Upside horizon (IA, 2525 vision — not a shipped claim): the expanding tool suite — detect → judge → approve → act → replay → improve — is the record's growing object set; by 2525 it carries the key features of every major crisis offering, each absorbed only after it clears the one-ninth (11.1 %) gate on its own clock, alerting last and certified — a horizon the architecture is built to hold, never a claim that any of it ships today.",
    ...
    S7: {
      ...
      desired: {
        hi: "Every approved decision carries its Horizon-1 governed-record objects (itemised on S14) — so the record answers what changed, why, who approved, and what happened next.",
    ...
    S12: {
      ...
      l60: {
        hi: [
          "Future commercial forms to test (customer WTP + CTS determine the form): the five candidate forms are itemised in the note.",
          "CTS to measure — the ten cost-to-serve items are itemised on S14 (Resourcing); measure actual CTS per segment.",
        ],
        ai: [
      ...
      l30: {
        hi: [
          "Validation sequence: 1 EDU — first proof · 2 FOOD — second proof · 3 TECH — scale-potential (the per-segment validation work is itemised in the note).",
          "This is a validation sequence, not a TAM (total addressable market) ranking.",
          "4 PUBLIC BODY — after G3 (IA, D12): the fourth step — one government owner, one project through the same loop; the full path is in the note; never a claimed customer.",
        ],
        ai: [
      ...
      l0: {
        ...
        ai: [
          ...
          "Upside horizon (IA, 2525 vision — not a shipped or savings claim): the full major-offering set is a commercial-reach horizon, dated govern 2027 · native 2030 · humanity's shared crisis memory 2525 — discovery-only beyond the primary set EDU · FOOD · TECH until a named buyer runs a major, each absorbed by qualification (the one-ninth (11.1 %) gate, alerting last and certified); the expanding tool suite is turned to critical outcomes and high-upside financial-crisis coordination; money stays DECLARED (IA), never buyer-validated.",
        ],
      },
    },
    ...
    S13: {
      ...
      deps: {
        hi: [
          ...
          MASTER_Q,
          "Public-body dependency (IA, after G3): one government owner steers one project through the same loop; the full path is in the note.",
        ],
        ai: [
          "G2 exit: buyer confirms the need · primary NBA confirmed · current-state baseline confirmed · at least two future-state deltas survive comparison · measurable clock defined · economic weight can be sourced · CTS path understood · pilot willingness exists.",
          MASTER_Q,
    ...
    S16: {
      saydo: {
        hi: [
          ["EDU — minutes event → approved objectives / posture (vs Rave)", "S16 A/B", "Measurable delta vs primary NBA", "Empty"],
    ...
    S17: {
      ...
      prio: {
        ...
        ai: [
          ...
          ["2525", "Humanity's shared, human-governed crisis memory: every institution's decisions, evidence and outcomes replayable across people, systems and generations in an open record; the affected community a participant, not only a recipient. By 2525 the record carries the key features of every major crisis offering, absorbed by qualification (the one-ninth gate, alerting last); the expanding tool suite — detect → judge → approve → act → replay → improve — turned to critical outcomes and high-upside financial-crisis coordination (IA, 2525 vision — not a shipped claim)", "Vision"],
      ...
      obs: {
        ...
        ai: [
          ...
          "Public bodies (R-CORE as it already runs here): a government steers a public project through the same loop — strategy → game plan → execution → delivered results — asks its people through the eXeL Polling API, decides with named authority, and shows them what was decided and why; every approved posture and its outcome replayable by the body that owns it and by the citizens it serves. After G3, one public-body pilot on the same record (IA, D12).",
          "Upside horizon (IA, 2525 vision — not a shipped or savings claim): the expanding tool suite — detect → judge → approve → act → replay → improve — built out around critical outcomes and high-upside financial-crisis situations, where getting the leadership loop right carries large upside; run through the same operating loop and dated govern 2027 · native 2030 · humanity's shared crisis memory 2525, with the key features of every major crisis offering absorbed by qualification into the one human-governed record; money stays DECLARED (IA), never buyer-validated and never a savings claim.",
        ],
      },
    },
    ...
    S18: {
      e120: {
        hi: [
          "DECLARED (not in v0.9): retire a governance-state capability only after its successor keeps the governed record — the Horizon-1 objects itemised on S14 — intact on the record.",
      ...
      e0: {
        hi: [
          ...
          "The decision register and the iteration ledger travel with the record.",
        ],
        ai: [
          "End-of-life communication to leadership, crisis team and stakeholders through the approved posture.",
          "The last event's replay carried into the successor: the next crisis does not restart from a blank page.",
          "The decision register and the iteration ledger travel with the record — every key decision, its revision and its author, replayable.",
          PROV,
        ],
      },
    },
