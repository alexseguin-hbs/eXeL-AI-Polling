...
const PROV = "Human-authored strategy · AI-assisted synthesis by eXeL AI · cross-review informed by Grok · twelve-lens review 2026-09-24 · final authority: De-Risking Strategies / Human Intelligence · v1.0 · rev 0.013";
...
export const SLIDE_SEED_DRS: SlideSeed = {
  "PRJ-34": {
    ...
    S1: {
      ...
      strategy: {
        hi: [
          "Thesis: ONE platform. CrisisCommand.ai carries every aspect of the benchmark's critical-event job — alert, workflow, continuity, risk feed — inside the governed leadership record: judgment → approved action → evidence → stakeholder response → learning.",
      ...
      ask: {
        hi: "G2 ask: approve the EDU / Rave, FOOD / Everbridge 360 AI and TECH / PagerDuty teardowns with buyer interviews, the EDU measurement-design tabletop, workflow prototypes, segment value equations, CTS discovery and S16 evidence tracking; G3 A/B simulation only after the G2 measurement design is credible.",
    ...
    S18: {
      ...
      e0: {
        hi: [
          ...
          "The decision register (D1–D15) and the iteration ledger travel with the record — every key decision, its revision and its author, replayable.",
        ],
        ai: [
          "End-of-life communication to leadership, crisis team and stakeholders through the approved posture.",
          "The last event's replay carried into the successor: the next crisis does not restart from a blank page.",
