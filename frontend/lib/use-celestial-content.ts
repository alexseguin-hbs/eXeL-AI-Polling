...
const LANG_LOADERS: Record<string, () => Promise<{ default: CelestialLangPack }>> = {
  ...
  id: () => import("./celestial-guide-id.json") as Promise<{ default: CelestialLangPack }>,
  ...
  ko: () => import("./celestial-guide-ko.json") as Promise<{ default: CelestialLangPack }>,
  ms: () => import("./celestial-guide-ms.json") as Promise<{ default: CelestialLangPack }>,
  ne: () => import("./celestial-guide-ne.json") as Promise<{ default: CelestialLangPack }>,
  nl: () => import("./celestial-guide-nl.json") as Promise<{ default: CelestialLangPack }>,
  ...
  ro: () => import("./celestial-guide-ro.json") as Promise<{ default: CelestialLangPack }>,
