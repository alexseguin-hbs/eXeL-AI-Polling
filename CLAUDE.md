...
| 6 AI Pipeline | ~86% | **86** | 190 | CRS-11→14 | C6-3/C6-5 DONE — Slice-0 offline theming E2E on 25 responses, 5-run determinism (identical inputs → identical themes). Remaining: B1 (5K E2E), B3 (scale verify) |
