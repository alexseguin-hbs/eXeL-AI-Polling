...
class TokenLedger(Base):
    ...
    delta_si: Mapped[float] = mapped_column(Float, default=0.0)
    delta_hi: Mapped[float] = mapped_column(Float, default=0.0)
    delta_ai: Mapped[float] = mapped_column(Float, default=0.0)
